...
for i in range(4):
    ...
    for listing in listings:
        ...
        if (prod_name != " "):
            ...
            # prod_price = float(re.sub(",", "", prod_price.split("INR")[1]))
...
# print(cricket_bats)
cricket_bats.to_csv('EBay_Cricket_Bat_Prices_On_{}.csv'.format(datetime.today().strftime('%Y-%m-%d')),index=False)
...
#
# # OPTIONALLY : Download all images for all listings for a particular search result
# for link in links:
